...
module riscvsingle (input  logic        clk, reset,
   ...
   logic [2:0]        ImmSrc;
   logic [31:0]       WriteData1, ReadData1;
   ...
   datapath dp (clk, reset, ResultSrc, ALUSrc, PCSrc,
		...
		ImmSrc, ALUControl,
		Zero, PC, Instr,
		ALUResult, WriteData1, ReadData1, PCReady);


    // I think this code will work for the stores and loads, now just implement on the fpga
    always_comb
      case(Instr[14:12])  // funct3
        3'b000:   ReadData1 = {{24{ReadData[7]}}, ReadData[7:0]};    // Load Byte
        3'b001:   ReadData1 = {{16{ReadData[15]}}, ReadData[15:0]};  // Load Half
        3'b100:   ReadData1 = {24'b0, ReadData[7:0]};                 // Load Byte Unsigned
        3'b101:   ReadData1 = {16'b0, ReadData[15:0]};                // Load Half Unsigned
        default:  ReadData1 = ReadData; // Load Word
      endcase
...
module aludec (input  logic       opb5,
   ...
   always_comb
     case(ALUOp)
       3'b00: ALUControl = {funct3[2:1], 3'b000}; // addition
       3'b01: ALUControl = {funct3[2:1], 3'b001}; // subtraction
       default: 
...
module datapath (input  logic        clk, reset,
   ...
   mux2 #(32)  pcmux (PCPlus4, PCTarget2, PCSrc, PCNext);
   // register file logic
   regfile  rf (clk, RegWrite, Instr[19:15], Instr[24:20],
	       Instr[11:7], Result, SrcRA, WriteData);             // Result and WriteData should swap names, not gonna mess with it so that I don't mess stuff up
   extend  ext (Instr[31:7], ImmSrc, ImmExt);
   // ALU logic
   mux2 #(32)  srcbmux (WriteData, ImmExt, ALUSrc[0], SrcB);
   mux2 #(32)  srcamux (SrcRA, PC, ALUSrc[1], SrcA);
